...
public class RoleCRUDRunner extends JUnitStories{
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new RoleCRUDSteps());
	}
	...
	protected List<String> storyPaths() {
		...
		return Arrays.asList("stories/RoleCRUD.story");
	}
}
