...
public class CritereCRUDRunner extends JUnitStories{
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new CritereCRUDSteps());
	}
	...
	protected List<String> storyPaths() {
		...
		return Arrays.asList("stories/CritereCRUD.story");
	}
}
