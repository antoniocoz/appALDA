...
public class PersonneCRUDRunner extends JUnitStories{
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new PersonneCRUDSteps());
	}
	...
	protected List<String> storyPaths() {
		...
		return Arrays.asList("stories/PersonneCRUD.story");
	}
}
